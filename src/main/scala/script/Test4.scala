...
object Test4 {
    ...
    def main(args: Array[String]) {
        val res = List(
            RawClassification.fromFile(new File("data/results/final_proj-jour_vec-conf2_or-1.0-tg-15XXXX_c45-boost-30-tss-1000-200_tg-15XXXX_final-test_proj-jour_vec-conf2_or-1.0-tg-15XXXX.json"))
